export default {
  id: '20260320-files-listing-access-coverage-order-v7',
  type: 'order',
  category: 'drupal',
  ...
  explanation: 'This question is based on the ADR "Files Listing Access". Use the ADR source link to review the exact recommendation and context.',
