export default {
  id: '20240924-11ty-adr-coverage-order-v3',
  type: 'order',
  category: 'general',
  ...
  explanation: 'This question is based on the ADR "11ty Adr". Use the ADR source link to review the exact recommendation and context.',
