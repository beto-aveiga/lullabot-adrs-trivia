export default {
  id: '20251210-create-deliberate-stacking-contexts-coverage-match-v4',
  type: 'matching',
  category: 'frontend',
  question: 'Match each ADR concept to its purpose for "Create Deliberate Stacking Contexts".',
  left: [
    'Decision',
    'Reasoning',
    'Default action',
